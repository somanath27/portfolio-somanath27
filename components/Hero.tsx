        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[3rem] items-center">
          <div>
            ...
            <p className="mt-[1.2rem] text-[15px] md:text-[17px] text-[#c4cfde]">
              ...
              exercitationem beatae praesentium incidunt repellat eligendi,
              repellendus tempora alias atque nostrum aperiam reiciendis aliquam
              voluptates nam! Sequi suscipit adipisci eius accusantium.
            </p>
